    ...
    return (
        <header className={styles.header}>
            <div className={styles.topBar}>
                <a className={variables.subtitle1} href="tel: +380939862262">+38 (093) 986-2262</a>
                {iconsContainer()}
                <a className={variables.subtitle1} href="tel: +380988447937">+38 (098) 844-7937</a>
            </div>
            <nav className={styles.headerContainer}>
                <div className={styles.inner}>
                    ...
                    <ul className={`${styles.navMenu} ${variables.button2}`}>
                        ...
                        <li className={styles.dropHover}><a className={styles.navMenuDropList} href="#"><span>Про нас</span><ArrowDown /></a>
                        ...
                        <li className={styles.dropHover}><a className={styles.navMenuDropList} href="#"> <span>Корисне</span><ArrowDown /></a>
                            {/* <ul className={`${styles.navMenu} ${variables.button2} ${styles.dropList}`}>
                                <li><a href="#">Щось</a></li>
                ...
                {open == true ? (
                    <div className={styles.dropDownMenuWrapper}>
                        ...
                        <button className={styles.donateButton}><span className={variables.button1}>Зробити внесок</span></button>
