...
async function fetchInitialCards() {
    const currentPage = 1;
    try {
        const response = await axios.get(`https://karg-backend.onrender.com/karg/animal/getall?page=${currentPage}&pageSize=6&CategoryFilter=&NameSearch=&cultureCode=ua`);
