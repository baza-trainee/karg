...
import styles from "./styles/statsForm.module.scss";
...
import { submitStatsData } from "../utilsSubmitStatsData";
...
function StatsForm({ type = 'create', statData = {} }) {
    ...
    const [formData, setFormData] = useState(initializeFormData(statData));
